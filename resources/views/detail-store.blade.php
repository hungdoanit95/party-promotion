        ...
        <div class="card-body">
          ...
          <div class="col-lg-12">
            <div class="user-confirm-qc">
              <span>{{ !empty($data['user_info'])&&$data['user_info']['username'] }}</span><button type="button" plan_id="{{ $data['plan_info']->plan_id }}" user_id="{{$data['user_info']['user_id']}}" group_id="{{ $data['user_info']['group_id'] }}" class="btn btn-info" id="btn-tick-qc">Xác nhận đã QC</button></div>
        ...
        <div class="card-body">
          ...
          <div class="content">
            ...
            <a href="javascript:void(0);" class="btn btn-info btn-confirm-report">
              ...
              <span>{{ !empty($data['user_info'])&&$data['user_info']['username'] }}</span> Xác nhận
            </a>
            @else
